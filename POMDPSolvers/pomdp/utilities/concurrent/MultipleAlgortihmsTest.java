...
import pomdp.algorithms.pointbased.ProbabilityGreedySearchValueIteration;
		...
		try{
			...
			for( iThread = 0 ; iThread < cThreads ; iThread++ ){
				...
				if( sMethodName.equals( "Pruning" ) ){
					...
					else if( sMethodName.equals( "PGSVI" ) ){
						viAlgorithm = new ProbabilityGreedySearchValueIteration(pomdp);
					}
