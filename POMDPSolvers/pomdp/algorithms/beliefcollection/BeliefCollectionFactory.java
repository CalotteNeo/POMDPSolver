...
public class BeliefCollectionFactory {
	...
	public static BeliefCollection getBeliefCollectionAlgorithm(String sName, ValueIteration vi,
			boolean bAllowDuplicates, boolean bUseFIB) {

		if (sName.equals("PGSVICollection"))
			return new PGSVICollection(vi, bAllowDuplicates);
